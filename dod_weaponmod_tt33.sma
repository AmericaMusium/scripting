...
#define WEAPON_SPECIAL_CODE 13112022 // need to change if you make another sma file with new weapon.
#define WEAPON_REFERENCE "weapon_colt"
#define WEAPON_ITEM_NAME "TT33" // Pistol Tulsky Tokareva

#define HUD_CLIP_ICON 3 	// HUD CLIP ICON 23 == fg42 / HUD AMMO is AMMO_RIFLE
#define HUD_AMMO_ICON 20 	// NOT USED
#define WEAPON_DAMAGE 1  	// DAMAGE MULTIPLIER
#define FIRE_RATE 0.23  	// shooting speed per
#define WEAPON_ANIM_RELOAD_TIME 2.5	// ERROR
#define WEAPON_MAXCLIP 8
#define WEAPON_PUNCHAGNLE 0.01	// NOT USING YET

#define WEAPON_SOUND_SHOOT "weapons/red/tt33fire.wav"
new const WEAPON_MODEL_VIEW[] = "models/red/v_tt33.mdl";
new const WEAPON_MODEL_PLAYER[] = "models/red/p_tt33.mdl";
new const WEAPON_MODEL_WORLD[] = "models/red/w_tt33.mdl";


#define PLUGIN "weapon_tt33"
#define VERSION "1.6"
...
public plugin_init()
{
	...
	register_clcmd("say /tt33", "CustomWeapon_Give")
	...
	RegisterHam(Ham_DOD_Item_CanDrop, "weapon_colt","CurWeapon_Drop");
	RegisterHam(Ham_DOD_Item_CanDrop, "weapon_webley","CurWeapon_Drop");
    RegisterHam(Ham_DOD_Item_CanDrop, "weapon_luger","CurWeapon_Drop");
...
public CurWeapon_PrimaryAttack_Pre(idWeapon)
{
	...
	//else if (Is_custom_w(idWeapon) && (ready_to_shoot == false)) return HAM_HANDLED;
...
// ExecuteHam(Ham_Weapon_PrimaryAttack, idWeapon);
// set_pdata_float(idWeapon, m_flTimeWeaponIdle, 1.8 , linux_diff_weapon);
...
public CustomWeapon_Give(idowner)
{
	...
	new temp_cur_weapon_ent_id = get_pdata_cbase(idowner, m_pistolItem) // to frop pistol use m_pistolItem
