...
public on_RoundStart()
{
    ...
    client_print(0, print_chat, "ROUNDSTARTNOW");
}
...
{   
    ...
    id_weapon == DODW_STICKGRENADE_EX )
    {
        ...
        client_print(idx_killer, print_chat, "GRENADE");
    }
    if( 
    id_weapon == DODW_GARAND_BUTT || 
    id_weapon == DODW_ENFIELD_BAYONET || 
    id_weapon == DODW_K43_BUTT ||
    id_weapon == DODW_KAR_BAYONET ||
    ...
    )
    {
        ...
        client_print(idx_killer, print_chat, "KINFE\BUTT\SPADE\BAYONET");
    }
    if ((get_gametime() - last_kill_time[idx_killer]) < 0.8)
    {
        ...
        client_print(idx_killer, print_chat, "DoubleKill");
    }
