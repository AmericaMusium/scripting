...
#define WEAPON_SPECIAL_CODE 7112022 // need to change if you make another sma file with new weapon.
#define WEAPON_REFERENCE "weapon_greasegun"
#define WEAPON_ITEM_NAME "AVT1940"
...
#define FIRE_RATE 0.17   	// shooting speed per
...
new const WEAPON_MODEL_VIEW[] = "models/red/v_avt40.mdl";
new const WEAPON_MODEL_PLAYER[] = "models/red/p_avt40.mdl";
new const WEAPON_MODEL_WORLD[] = "models/red/w_avt40.mdl";


#define PLUGIN "weapon_avt40"
#define VERSION "1.6" 
/*
...
public plugin_init()
{
	...
	register_clcmd("say /avt40", "CustomWeapon_Give")
