...
#define WEAPON_SPECIAL_CODE 12112022 // need to change if you make another sma file with new weapon.
#define WEAPON_REFERENCE "weapon_thompson"
#define WEAPON_ITEM_NAME "PPS43" // Sudaev's Semi-auto Pistol

#define HUD_CLIP_ICON 27 	// HUD CLIP ICON 23 == fg42 / HUD AMMO is AMMO_RIFLE
#define HUD_AMMO_ICON 20 	// NOT USED
#define WEAPON_DAMAGE 1  	// DAMAGE MULTIPLIER
#define FIRE_RATE 0.11  	// shooting speed per
#define WEAPON_ANIM_RELOAD_TIME 2.5	// ERROR
#define WEAPON_MAXCLIP 35
#define WEAPON_PUNCHAGNLE 0.01	// NOT USING YET

#define WEAPON_SOUND_SHOOT "weapons/red/pps43fire.wav"
new const WEAPON_MODEL_VIEW[] = "models/red/v_pps43.mdl";
new const WEAPON_MODEL_PLAYER[] = "models/red/p_pps43.mdl";
new const WEAPON_MODEL_WORLD[] = "models/red/w_pps43.mdl";

#define PLUGIN "weapon_pps43"
#define VERSION "1.0"
...
public plugin_init()
{
	...
	register_clcmd("say /pps43", "CustomWeapon_Give")
	...
	*/
	...
	for ( cbase = 82; cbase < 86; cbase++ ) 
	{
		...
		if (activeitem > 32)
		{
			...
			// engfunc(EngFunc_SetModel, weaponbox, KNIVES_MODELS[1]) 
...
Error: server failed to transmit file 'sound/weapons/pps43_reload_clipout.wav'
Error: server failed to transmit file 'sound/weapons/pps43_reload_clipin.wav'
Error: server failed to transmit file 'sound/weapons/pps43_draw_slideback.wav'
Error: server failed to transmit file 'sound/weapons/pps43_reload_slideback.wav'
*/