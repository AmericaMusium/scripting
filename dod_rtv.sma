...
public plugin_init()
{
	...
	howmanyvotes = register_cvar("amx_howmanyvotes", "2");
	howmanyvotesperc = register_cvar("amx_howmanypercentage", "0.60");
	task_time = register_cvar("amx_rocktime", "15.0");
	timevote = register_cvar("amx_timevote", "20");
	directmapchange = register_cvar( "amx_directmapchange", "1" );
...
public rockthevote(id)
{
	new said[192];
	read_args(said, 192);
	if	((contain(said, "/rockthevote") != -1) || (contain(said, "/rtv") != -1) || (contain(said, "rockthevote") != -1) || (contain(said, "rtv") != -1))
	{
